...
gooseWindow.windowScene = keyWindow.windowScene;
	...
	[[%c(NSDistributedNotificationCenter) defaultCenter]
		addObserverForName:@"me.zsaaiq.mobilegoose/ModPreferencesChanged"
		object:nil
		queue:nil
...
%ctor {
	CFNotificationCenterAddObserver(
		...
		NULL,
		&MGResetPreferences,
		CFSTR("me.zsaaiq.mobilegoose/PreferenceChange"),
		NULL,
		0
	);
	CFNotificationCenterAddObserver(
		...
		CFSTR("me.zsaaiq.mobilegoose/Exit"),
		NULL,
		0
	);
